...
class Ui_DialogDonate(object):
    def setupUi(self, DialogDonate):
        ...
        self.labelWechat.setPixmap(QtGui.QPixmap(":/image/susan-wechat.jpg"))
        ...
        self.labelAlipay.setPixmap(QtGui.QPixmap(":/image/susan-alipay.jpg"))
    ...
    def retranslateUi(self, DialogDonate):
        ...
        self.labelDonate.setText(_translate("DialogDonate", "Donate"))
        self.btnWechat.setText(_translate("DialogDonate", "WeChat"))
        self.btnAlipay.setText(_translate("DialogDonate", "AliPay"))
